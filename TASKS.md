...
| 9 | Frontend scaffold + DEMO_MODE — Next.js 14 App Router, Tailwind, shadcn/ui; `NEXT_PUBLIC_DEMO_MODE=true` serves `fixtures/mock_results.json` | C | todo | `npm run dev` and `localhost:3000` renders with the backend stopped |
